...
### byte
[string.byte(string: string, start: number, end: number): number](string/byte.md)
> Returns the given string's characters in their numeric ASCII representation.

### char
[string.char(...): string](string/char.md)
> Creates a string from one or more numeric ASCII codes.

### find
[string.find(str: string, pattern: string, start: number, no_patterns: boolean): number, number](string/find.md)
...
### format
[string.format(format: string, ...)](string/format.md)
...
### gmatch
[string.gmatch(str: string, pattern: string): function](string/gmatch.md)
...
### gsub
[string.gsub(str: string, pattern: string, replacement: string, max: number): string, number](string/gsub.md)
...
### len
[string.len(str: string): number](string/len.md)
> Returns the length of the string `str` in bytes.

### lower
[string.lower(str: string): string](string/lower.md)
> Returns a copy of `str` with all uppercase letters replaced by their lowercase counterparts.

### match
[string.match(str: string, pattern: string, start): table](string/match.md)
...
### rep
[string.rep(str: string, n: number, sep: string): string](string/rep.md)
> Repeats the string `n` times and concatenates them using the separator `sep`.

### reverse
[string.reverse(str: string): string](string/reverse.md)
> Reverses the string `str`.

### sub
[string.sub(str: string, s: number, e: number): string](string/sub.md)
> Returns a substring of `str` starting at `s` and ending at `e`. Use negative numbers to start from the end of the string.

### upper
[string.upper(str: string): string](string/upper.md)
