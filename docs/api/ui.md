...
### get
[ui.get(item: number): any](ui/get.md)
...
### is_menu_open
[ui.is_menu_open(): boolean](ui/ismenuopen.md)
> Returns true if the menu is currently open.

### menu_position
[ui.menu_position(): number, number](ui/menuposition.md)
> Returns the x, y of the menu, even when closed.

### menu_size
[ui.menu_size(): number, number](ui/menusize.md)
> Returns the width, height of the menu, even when closed.

### mouse_position
[ui.mouse_position(): number, number](ui/mouseposition.md)
> Returns current mouse coordinates x, y

### name
[ui.name(item: number): string](ui/name.md)
> Returns the display name

### new_button
[ui.new_button(tab: string, container: string, name: string, callback): number](ui/newbutton.md)
> Throws an error on failure. The return value should not be used with ui.set or ui.get.

### new_checkbox
[ui.new_checkbox(tab: string, container: string, name: string): number](ui/newcheckbox.md)
> Returns a special value that can be passed to ui.get and ui.set, or throws an error on failure.

### new_color_picker
[ui.new_color_picker(tab: string, container: string, name: string, r: number, g: number, b: number, a: number): number](ui/newcolorpicker.md)
> Throws an error on failure. The color picker is placed to the right of the previous menu item.

### new_combobox
[ui.new_combobox(tab: string, container: string, name: string, ...): number](ui/newcombobox.md)
> Returns a special value that can be passed to ui.get and ui.set, or throws an error on failure.

### new_hotkey
[ui.new_hotkey(tab: string, container: string, name: string, inline: boolean, default_hotkey: number): number](ui/newhotkey.md)
> Returns a special value that can be passed to ui.get to see if the hotkey is pressed, or throws an error on failure.

### new_label
[ui.new_label(tab: string, container: string, name: string): number](ui/newlabel.md)
...
### new_listbox
[ui.new_listbox(tab: string, container: string, name: string, items: table): number](ui/newlistbox.md)
...
### new_multiselect
[ui.new_multiselect(tab: string, container: string, name: string, ...): number](ui/newmultiselect.md)
> Returns a special value that can be passed to ui.get and ui.set, or throws an error on failure.

### new_slider
[ui.new_slider(tab: string, container: string, name: string, min: number, max: number, init_value: number, show_tooltip: boolean, unit: string, scale: number, tooltips: table): number](ui/newslider.md)
> Returns a special value that can be passed to ui.get and ui.set, or throws an error on failure.

### new_string
[ui.new_string(name: string, default_value: string): number](ui/newstring.md)
...
### new_textbox
[ui.new_textbox(tab: string, container: string, name: string): number](ui/newtextbox.md)
> Throws an error on failure. Returns a special value that can be used with ui.get

### reference
[ui.reference(tab: string, container: string, name: string): number](ui/reference.md)
...
### set
[ui.set(item: number, value: any, ...)](ui/set.md)
...
### set_callback
[ui.set_callback(item: number, callback)](ui/setcallback.md)
> Sets the change callback of a custom menu item. It will be executed on change and passed the reference

### set_enabled
[ui.set_enabled(item: number, enabled: boolean)](ui/setenabled.md)
> Sets the enabled state of the menu item

### set_visible
[ui.set_visible(item: number, visible: boolean)](ui/setvisible.md)
> Sets the visibility of the menu item

### type
[ui.type(item: number)](ui/type.md)
> Returns the type of an element

### update
[ui.update(item: number, value: any, ...)](ui/update.md)
> Creates a string UI element, can be used to store arbitrary strings in configs. No menu item is created but it has the same semantics as other ui.new_* functions. Returns a special value that can be passed to ui.get and ui.set, or throws an error on failure.
