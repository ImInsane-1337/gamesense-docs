...
### arshift
[bit.arshift(x: number, n: number): number](bit/arshift.md)
...
### band
[bit.band(x1: number, ...): number](bit/band.md)
> Returns the bitwise and of all of its arguments. Note that more than two arguments are allowed.

### bnot
[bit.bnot(x: number): number](bit/bnot.md)
> Returns the bitwise not of its argument (all bits flipped).

### bor
[bit.bor(x1: number, ...): number](bit/bor.md)
> Returns the bitwise or of all of its arguments. Note that more than two arguments are allowed.

### bswap
[bit.bswap(x: number): number](bit/bswap.md)
> Swaps the bytes of its argument and returns it. This can be used to convert little-endian 32 bit numbers to big-endian 32 bit numbers or vice versa.

### bxor
[bit.bxor(x1: number, ...): number](bit/bxor.md)
> Returns the bitwise xor of all of its arguments. Note that more than two arguments are allowed.

### lshift
[bit.lshift(x: number, n: number): number](bit/lshift.md)
...
### rol
[bit.rol(x: number, n: number): number](bit/rol.md)
...
### ror
[bit.ror(x: number, n: number): number](bit/ror.md)
...
### rshift
[bit.rshift(x: number, n: number): number](bit/rshift.md)
...
### tobit
[bit.tobit(x: number): number](bit/tobit.md)
> Normalizes a number to the numeric range for bit operations and returns it. This function is usually not needed since all bit operations already normalize all of their input arguments.

### tohex
[bit.tohex(x: number, n: number): string](bit/tohex.md)
