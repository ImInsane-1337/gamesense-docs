...
### get_all
[entity.get_all(classname: string): table](entity/getall.md)
...
### get_bounding_box
[entity.get_bounding_box(ent: number): number, number, number, number, number](entity/getboundingbox.md)
...
### get_classname
[entity.get_classname(ent: number): string](entity/getclassname.md)
> Returns the name of the entity's class.

### get_esp_data
[entity.get_esp_data(player: number): table](entity/getespdata.md)
> Returns a table containing alpha, health, flags, and weapon_id, or nil on failure.

### get_game_rules
[entity.get_game_rules(): number](entity/getgamerules.md)
> Returns the entity index of the `CCSGameRulesProxy` instance, or nil if none exists.

### get_local_player
[entity.get_local_player(): number](entity/getlocalplayer.md)
> Returns the entity index for the local player, or nil on failure.

### get_origin
[entity.get_origin(ent: number): number, number, number](entity/getorigin.md)
...
### get_player_name
[entity.get_player_name(player: number): string](entity/getplayername.md)
> Returns the player's name, or the string "unknown" on failure.

### get_player_resource
[entity.get_player_resource(): number](entity/getplayerresource.md)
> Returns the entity index of the `CCSPlayerResource` instance, or nil if none exists.

### get_player_weapon
[entity.get_player_weapon(player: number): number](entity/getplayerweapon.md)
> Returns the entity index of the player's active weapon, or nil if the player is not alive, dormant, etc.

### get_players
[entity.get_players(enemies_only: boolean): table](entity/getplayers.md)
> Returns an array of player entity indices. Dormant and dead players will not be added to the list.

### get_prop
[entity.get_prop(ent: number, prop: string, array_index: number):](entity/getprop.md)
> Returns the value of the property, or nil on failure. For vectors or angles, this returns three values.

### get_steam64
[entity.get_steam64(player: number): number](entity/getsteam64.md)
> Returns the player's SteamID3, or nil on failure.

### hitbox_position
[entity.hitbox_position(player: number, hitbox: number): number, number, number](entity/hitboxposition.md)
> Returns world coordinates of the hitboxes, or nil on failure.

### is_alive
[entity.is_alive(ent: number): boolean](entity/isalive.md)
> Returns true if the player is not dead.

### is_dormant
[entity.is_dormant(ent: number): boolean](entity/isdormant.md)
> Returns true if the entity is dormant.

### is_enemy
[entity.is_enemy(ent: number): boolean](entity/isenemy.md)
> Returns true if the entity is on the opposing team.

### new_prop
[entity.new_prop(propname: string, offset: number, type: number, array_type: number, array_element_size: number, array_count: number)](entity/newprop.md)
> Creates a new entity prop that can then be read and modified with [entity.get_prop](entity.md) / [entity.set_prop](entity.md).

### set_prop
[entity.set_prop(ent: number, prop: string, ..., array_index: number)](entity/setprop.md)
